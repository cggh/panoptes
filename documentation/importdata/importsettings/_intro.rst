...
.. Note::
  ...
  and can serve as a starting point to explore the possible options. There is also a `VCF example <https://github.com/cggh/panoptes/tree/master/sampledata/datasets/vcf_example>`_ which shows data imported from VCF.
