...
console.log('TableMarkersLayerWidget props: %o', this.props);
console.log('TableMarkersLayerWidget context: %o', this.context);
console.log('TableMarkersLayerWidget markers: %o', markers);
