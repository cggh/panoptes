...
//                    });
                ...
                that.createPropertyPopup = function(propid) {
                    ...
                    if (thecol.sortOption) {
                        buttons.push( Controls.Button(null, { buttonClass: 'DQXToolButton2', content: "Sort<br>ascending", bitmap:DQX.BMP('arrow7up.png'), width:120, height:40 })
                            .setOnChanged(function() {
                                that.panelTable.getTable().sortByColumn(propid,false);
                            }) );
                        buttons.push( Controls.Button(null, { buttonClass: 'DQXToolButton2', content: "Sort<br>descending", bitmap:DQX.BMP('arrow7down.png'), width:120, height:40 })
                            .setOnChanged(function() {
